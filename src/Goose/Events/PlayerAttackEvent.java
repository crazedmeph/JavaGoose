...
public class PlayerAttackEvent extends Event {
    ...
    public void ready(GameWorld world) throws Exception {
        if (this.getPlayer().getState() == Goose.Player.States.Ready) {
            for (Buff buff : this.getPlayer().getBuffs()) {
            ...
            long delay = (long) (((double) (this.getPlayer().getWeaponDelay() / 10.0) * (1 - this.getPlayer()
            ...
            if (now - this.getPlayer().getLastAttack() >= delay) {
                ...
                int playerFacing = this.getPlayer().getFacing();
                if (playerFacing == 1) {
                    y--;
                ...
                if (character != null)
                    this.getPlayer().attack(character, world);
            }
        }
    }
}
